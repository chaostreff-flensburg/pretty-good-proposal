...
const onSubmit = handleSubmit (async (values, actions) => {
    try {
        if (proposal.value.captcha.toLowerCase() !== 'flensburg') throw Error('Wrong Captcha')
...
<template>
    <div class="card">
        ...
        <form @submit="onSubmit">
            ...
            <div class="field col flex flex-column">
                <label for="reasonApplicationThesis"> Warum passt deine Arbeit ins Thema? max. 1000 Zeichen</label>
                <Textarea rows="5" v-model="proposal.reasonApplicationThesis" max="1000" />
            </div>
            <div class="field col flex flex-column">
                <label for="reasonApplicationPerson">Erzähl uns etwas über dich? max. 1000 Zeichen</label>
                <Textarea rows="5" v-model="proposal.reasonApplicationPerson" max="1000" />
            </div>
            <div class="field col flex flex-column">
